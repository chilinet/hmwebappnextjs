...
/**
 * Holt gecachte Devices für einen Customer, auch wenn abgelaufen (für Fallback)
 * @param {string} customerId - Customer ID
 * @returns {Array|null} Gecachte Devices oder null wenn nicht vorhanden
 */
export function getCachedDevicesEvenExpired(customerId) {
  const cached = deviceCache.get(customerId);
